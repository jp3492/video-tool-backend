...
module.exports = function(app) {
  ...
  app.patch('/comment/:_id', auth, Tag.postComment);
  app.patch('/comment/:tagId/:commentId', auth, Tag.patchComment);
  app.patch('/comment/delete/:tagId/:commentId', auth, Tag.deleteComment);
